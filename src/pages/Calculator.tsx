...
import { Calculator as CalcIcon, Utensils, Info, ArrowRight } from 'lucide-react';
    ...
    <div className="calc-container">
      ...
      <div className="card calculator-card glass">
        <div className="input-group">
          <label><Utensils size={16} /> Mahsulot miqdori (gramm)</label>
          <input 
            type="number" 
            value={foodAmount} 
        ...
        <div className="input-group">
          <label><Info size={16} /> 100g tarkibidagi uglevod (g)</label>
          <input 
            type="number" 
            value={carbsPer100g} 
        ...
        <div className="final-result card">
          ...
          <h2>{insulin.toFixed(1)} <sub>birlik</sub></h2>
          <p className="formula-hint">Formula: {nan.toFixed(1)} NAN × {profile?.nanInsulin || 1} birlik</p>
        </div>
      </div>
      ...
      <section className="card promo-card glass">
        ...
        <div className="promo-content">
          ...
          <button className="text-btn">Tarixga o'tish <ArrowRight size={16} /></button>
        </div>
      </section>
    </div>
  );
